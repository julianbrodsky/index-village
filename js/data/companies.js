...
import batch10 from './lines/batch-10.js';
import batch11 from './lines/batch-11.js';

const LINES = { ...batch01, ...batch02, ...batch03, ...batch04, ...batch05, ...batch06, ...batch07, ...batch08, ...batch09, ...batch10, ...batch11 };
